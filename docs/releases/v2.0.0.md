...
uploads toward manifest-declared client preprocessing and fixed persisted variants,
...
- Persists fixed-recipe WebP variants instead of generating thumbnails on the
...
V2 generates the following fixed-recipe assets:
